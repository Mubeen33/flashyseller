@if(isset($draftShippmentsorders))
@foreach($draftShippmentsorders as $key=>$content)
                                ...
                                <tr style="background: aliceblue;">
                                    ...
                                    <td width="15%">
                                        <div class="dropdown">
                                                <button class="btn btn-danger btn-sm"><a href="{{ Route('vendor.orderWayBill.post', [encrypt($key)]) }}" style="color:#fff">Request Waybill</a></button>
                                            </div>
                                        </div>
                                    </td>   
                                </tr> 
