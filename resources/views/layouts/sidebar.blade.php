    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="{{ route('vendor.deals.create') }}"><i class="feather icon-shopping-cart"></i><span class="menu-title" data-i18n="Ecommerce">New Deal Request</span></a>
                </li>
                <li class=" nav-item"><a href="{{ route('vendor.deals.index') }}"><i class="feather icon-user"></i><span class="menu-title" data-i18n="User">My Deals</span></a>
                </li>

                {{-- Sales --}}
                <li class=" navigation-header"><span>Sales</span>
                <li class=" nav-item"><a href="{{ route('vendor.orders.index') }}"><i class="feather icon-shopping-cart"></i><span class="menu-title" data-i18n="Ecommerce">In House Orders</span></a>
                </li>
                {{-- Transactions --}}
                <li class=" navigation-header"><span>Transactions</span>
                <li class=" nav-item"><a href="{{ route('vendor.transactions') }}"><i class="feather icon-user"></i><span class="menu-title" data-i18n="User">My Transactions</span></a>
                </li>
