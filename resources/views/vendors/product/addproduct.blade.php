	...
	<div class="container-fluid">
		...
		<div class="card">
				...
				<div class="row">
					...
					<div class="col-lg-2">
							<div class="img-box1" n="1" product="img">
								<div id="imgg1">
									<i class="fa fa-camera"></i> <br />
									Add a photo
								</div>
								 <img src="img.jpg" style="display:none;" class="img-box" id="img1"  height="100%" width="100%">
							</div> <br />
							<input type="file" name="img1" id="pimg1" style="display:none;" />
					
					</div>
					<div class="col-lg-2">
						<div class="img-box1" n="2" product="img">
							<div id="imgg2">
								<i class="fa fa-camera"></i> <br />
								Add a photo
							</div>
							<img src="img.jpg" class="img-box" id="img2"  height="187px" width="100%" style="display:none;">
						</div>
						<input type="file" name="img2" id="pimg2" style="display:none;" />
					</div>
					<div class="col-lg-2">
						<div class="img-box1" n="3" product="img">
							<div id="imgg3">
								<i class="fa fa-camera"></i> <br />
								Add a photo
							</div>
							<img src="img.jpg" class="img-box" id="img3"  height="187px" width="100%" style="display:none;">
						</div>
						<input type="file" name="img3" id="pimg3" style="display:none;" />
					</div>
					<div class="col-lg-2">
						<div class="img-box1" n="4" product="img">
							<div id="imgg4">
								<i class="fa fa-camera"></i> <br />
								Add a photo
							</div>
							<img src="img.jpg" class="img-box" id="img4"  height="187px" width="100%" style="display:none;">
						</div>
						<input type="file" name="img4" id="pimg4" style="display:none;" />
					</div>
					<div class="col-lg-2">
								<div class="img-box1" n="5" product="img">
								<div id="imgg5">
									<i class="fa fa-camera"></i> <br />
									Add a photo
								</div>
								<img src="img.jpg" class="img-box" id="img5"  height="187px" width="100%" style="display:none;">
							</div>
